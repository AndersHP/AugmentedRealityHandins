...
public class LaserShooter2 : MonoBehaviour {
	...
	Vector3 leftCannonPos = new Vector3(-0.4f, 0, 7f);
	...
	void Update () {
		...
		Vector3 worldPosLeft =   falcon.transform.position + leftCannonPos + falcon.transform.rotation * leftCannonPos;
